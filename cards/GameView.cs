...
namespace cards
{
    public partial class FormBlackjack : MetroForm
    {
        ...
        public FormBlackjack()
        {
            ...
            controller = new Game(player1, dealer, metroLabelDisplay, metroButtonHit, metroButtonStand, metroButtonRestart, metroButtonConfirmBet, metroTextBoxBet, metroLabelPlayerScore, metroLabelDealerScore,
        ...
        //        player1.ResetDisplay(metroLabelPlayerScore, metroListViewPlayer);
        //        dealer.ResetDisplay(metroLabelDealerScore, metroListViewDealer);
        //        player1.Reset();
        //        round++;
        ...
        private void metroButtonConfirmBet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //    MetroMessageBox.Show(this, "You cannot bet more money than you have");
                //else if (player1.GetBet() < 1)
                //    MetroMessageBox.Show(this,"Bet cannot be less than 1");
                //else
                //{
                //    player1.UpdateMoney(-player1.GetBet());
                //    player1.UpdateMoneyDisplay(metroLabelMoney);
